...
<strong>main</strong> → Versão estável do sistema  
<strong>feature/programar-models</strong> → Desenvolvimento de novas funcionalidades nos models  
<strong>feature/programar-validation</strong> → Desenvolvimento de validações para garantir o correto funcionamento dos models  
<strong>fix/bugs-models</strong> → Correção de bugs identificados durante o desenvolvimento dos models  
